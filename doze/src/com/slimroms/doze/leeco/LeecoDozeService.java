...
public class LeecoDozeService extends Service {
    private static final String TAG = "LeecoDozeService";
    ...
    private LeecoProximitySensor mSensor;
    ...
    class LeecoProximitySensor implements SensorEventListener {
        ...
        public LeecoProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "LeecoDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new LeecoProximitySensor(mContext);
        mWakeLock = mPowerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "LeecoDozeWakeLock");
